...
-- | Convert an operation expression (including binary, postfix and prefix)
-- | to an abstract function application.
...
-- | A postfix expression is just a function application with the operator as
-- | the function and the operand as the argument.
-- | So, e op is equivalent to op(e).
